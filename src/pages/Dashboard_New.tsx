...
const Dashboard = () => {
  ...
  const userData = {
    ...
    totalPoints: 12450,
    availablePoints: 8720,
    redeemedPoints: 3730,
    lastActivity: "October 14, 2025",
  ...
  // Enhanced metrics dashboard for citizen rewards
  const dashboardMetrics = [
    ...
    },
    {
      ...
      changeType: "increase", 
      icon: "🌟",
      description: "Positive community contributions"
    },
    {
      ...
      changeType: "neutral",
      icon: "🔥",
      description: "Daily engagement streak"
    },
    {
      title: "Membership Level",
      value: "Gold",
      change: "2,550 to Platinum",
      changeType: "positive",
      icon: "👑",
      description: "Exclusive benefits active"
    }
  ];
